# How to show current location in the .NET MAUI Maps (SfMaps)?
This repository contains a sample to show current location in the [Syncfusion .NET MAUI Maps](https://help.syncfusion.com/maui/maps/getting-started) control.
